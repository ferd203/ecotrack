...
public class TChronometerStopBeginJava
{
  ...
  protected final String TEXT_15 = " - Duration since job start: \"+time";
  protected final String TEXT_16 = NL + "\t   \t\tSystem.out.print(\"[ ";
  protected final String TEXT_17 = " ]  \");" + NL + "\t\t";
  protected final String TEXT_18 = NL + "\t    \tSystem.out.print(\"   \" + time";
  protected final String TEXT_19 = "/1000 + \"seconds   \");" + NL + "\t\t    " + NL + "\t  \t\t";
  protected final String TEXT_20 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_21 = " - Readable duration : \"+ time";
  protected final String TEXT_22 = "/1000 + \" seconds\");" + NL + "\t\t\t";
  protected final String TEXT_23 = NL + "\t  \tSystem.out.println(";
  protected final String TEXT_24 = " + \"  \" + time";
  protected final String TEXT_25 = " + \" milliseconds\");" + NL + "\t  \t";
  protected final String TEXT_26 = " - \"+ ";
  protected final String TEXT_27 = " + \" milliseconds\");" + NL + "\t\t";
  protected final String TEXT_28 = " " + NL + "\t";
  protected final String TEXT_29 = NL + "\tLong currentTime";
  protected final String TEXT_30 = " = System.currentTimeMillis();" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_31 = "\", currentTime";
  protected final String TEXT_32 = ");" + NL + "\t";
  protected final String TEXT_33 = " - Current time \" + currentTime";
  protected final String TEXT_34 = " + \" milliseconds\");" + NL + "\t";
  protected final String TEXT_35 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_36 = "_STOPTIME\", currentTime";
  protected final String TEXT_37 = ");" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_38 = "_DURATION\", time";
