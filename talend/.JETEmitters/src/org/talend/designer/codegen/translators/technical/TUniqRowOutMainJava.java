...
public class TUniqRowOutMainJava
{
  ...
  protected final String TEXT_20 = " = 0; i_";
  protected final String TEXT_21 = " < bufferSize_1_";
  protected final String TEXT_22 = "; i_";
  protected final String TEXT_23 = "++) {" + NL + "\t    \tbuffer_1_";
  protected final String TEXT_24 = "[i_";
  protected final String TEXT_25 = "].writeData(rw);" + NL + "\t    }" + NL + "\t                    " + NL + "\t    rw.close();" + NL + "\t\t";
  ...
  protected final String TEXT_30 = " = 0;" + NL + "\t}" + NL + "\trowStruct_";
  protected final String TEXT_31 = " row_";
  protected final String TEXT_32 = " = buffer_1_";
  protected final String TEXT_33 = "[rowsInBuffer_1_";
  protected final String TEXT_34 = "++];" + NL + "\trow_";
  protected final String TEXT_35 = ".id_";
  protected final String TEXT_36 = " = ++nb_";
