...
public class TPostgresqlSCDBeginJava {
  ...
  protected final String TEXT_14 = ";" + NL + "        java.lang.Class.forName(\"org.postgresql.Driver\");";
  ...
  protected final String TEXT_28 = NL + "\t   \t" + NL + "        java.sql.Connection connection_";
  ...
  protected final String TEXT_36 = ";" + NL + "    } else {" + NL + "        tableName_";
  protected final String TEXT_37 = " = dbSchema_";
  protected final String TEXT_38 = " + \"\\\".\\\"\" + ";
  protected final String TEXT_39 = ";" + NL + "    }" + NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_40 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_41 = " = null;    ";
  protected final String TEXT_42 = NL + "        String searching_";
  protected final String TEXT_43 = " = \"";
  protected final String TEXT_44 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_45 = " = connection_";
  protected final String TEXT_46 = ".prepareStatement(searching_";
  protected final String TEXT_47 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_48 = " = null;";
  protected final String TEXT_49 = NL + "        String search_";
  protected final String TEXT_50 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_51 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_52 = " = statement_";
  protected final String TEXT_53 = ".executeQuery(search_";
  protected final String TEXT_54 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_55 = ", SCDStruct_";
  protected final String TEXT_56 = "> cache_";
  protected final String TEXT_57 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_58 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_59 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_60 = " sk_";
  protected final String TEXT_61 = " = new SCDSK_";
  protected final String TEXT_62 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_63 = " row_";
  protected final String TEXT_64 = " = new SCDStruct_";
  protected final String TEXT_65 = "();";
  protected final String TEXT_66 = NL + "                    tmpValue_";
  protected final String TEXT_67 = " = resultSet_";
  ...
  protected final String TEXT_71 = ".length() > 0) {";
  protected final String TEXT_72 = NL + "                        ";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = " = tmpValue_";
  protected final String TEXT_75 = ".charAt(0);" + NL + "                    } else {";
  protected final String TEXT_76 = NL + "                            if(tmpValue_";
  protected final String TEXT_77 = " == null) {";
  protected final String TEXT_78 = NL + "                                ";
  protected final String TEXT_79 = " = null;" + NL + "                            } else {";
  ...
  protected final String TEXT_89 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_90 = " != null) {";
  protected final String TEXT_91 = " = new java.util.Date(timestamp_";
  protected final String TEXT_92 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_93 = " = null;" + NL + "                    }";
  protected final String TEXT_94 = NL + "                    if(resultSet_";
  ...
  protected final String TEXT_100 = NL + "            cache_";
  protected final String TEXT_101 = ".put(sk_";
  protected final String TEXT_102 = ", row_";
  protected final String TEXT_103 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_104 = ".close();" + NL + "        statement_";
  protected final String TEXT_105 = ".close();";
  protected final String TEXT_106 = NL + "            System.out.println(\"[";
  protected final String TEXT_107 = "] comparison cache loaded\");";
  ...
  protected final String TEXT_119 = NL + "        if(tmpRS_";
  protected final String TEXT_120 = ".next() && tmpRS_";
  protected final String TEXT_121 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_122 = " = tmpRS_";
  protected final String TEXT_123 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_124 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_125 = NL + "            }            ";
  protected final String TEXT_126 = NL + "    String insertionSQL_";
  protected final String TEXT_127 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_128 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_129 = NL + "            insertionStatement_";
  protected final String TEXT_130 = ".setTimestamp(";
  protected final String TEXT_131 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_132 = "\")));";
  protected final String TEXT_133 = ".setNull(";
  protected final String TEXT_134 = ", java.sql.Types.DATE);";
  protected final String TEXT_135 = NL + "            String endDateTimeDetail_";
  protected final String TEXT_136 = ";" + NL + "            String datePattern_";
  protected final String TEXT_137 = " = \"yyyy-MM-dd\";" + NL + "            if(endDateTimeDetail_";
  protected final String TEXT_138 = ".length()>0){" + NL + "            \tendDateTimeDetail_";
  protected final String TEXT_139 = " = \" \"+endDateTimeDetail_";
  protected final String TEXT_140 = ";" + NL + "            \tdatePattern_";
  protected final String TEXT_141 = " = \"yyyy-MM-dd HH:mm:ss\";" + NL + "            }" + NL + "            insertionStatement_";
  protected final String TEXT_142 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(datePattern_";
  protected final String TEXT_143 = ").parse(";
  protected final String TEXT_144 = " + \"-01-01\"+endDateTimeDetail_";
  protected final String TEXT_145 = ").getTime()));";
  protected final String TEXT_146 = NL + "        String updateSQLForType1_";
  protected final String TEXT_147 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_148 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_149 = ");        ";
  protected final String TEXT_150 = NL + "        String updateSQLForType2_";
  protected final String TEXT_151 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_152 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_153 = NL + "            updateForType2_";
  protected final String TEXT_154 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_155 = NL + "        String updateSQLForType3_";
  protected final String TEXT_156 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_157 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_158 = NL + "        SCDSK_";
  protected final String TEXT_159 = " lookUpKey_";
  protected final String TEXT_160 = " = null;        ";
  protected final String TEXT_161 = NL + "    SCDStruct_";
  protected final String TEXT_162 = " lookUpValue_";
