...
public class TPostgresqlSCDMainJava {
  ...
  protected final String TEXT_32 = NL + "                    timestamp_";
  protected final String TEXT_33 = ".getTimestamp(";
  protected final String TEXT_34 = ");" + NL + "                    if(timestamp_";
  protected final String TEXT_35 = " != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_36 = " = new java.util.Date(timestamp_";
  protected final String TEXT_37 = ".getTime());" + NL + "                    } else {" + NL + "                        lookUpValue_";
  protected final String TEXT_38 = " = null;" + NL + "                    }";
  protected final String TEXT_39 = NL + "                    if(searchingResult_";
  protected final String TEXT_40 = ".getObject(";
  protected final String TEXT_41 = ") != null) {" + NL + "                        lookUpValue_";
  protected final String TEXT_42 = ".get";
  protected final String TEXT_43 = "(";
  protected final String TEXT_44 = ");" + NL + "                    }";
  protected final String TEXT_45 = NL + "        }" + NL + "        searchingResult_";
  protected final String TEXT_46 = ".close();";
  protected final String TEXT_47 = NL + " \ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_48 = " = new SCDSK_";
  protected final String TEXT_49 = NL + "            lookUpKey_";
  protected final String TEXT_50 = " = ";
  protected final String TEXT_51 = ";";
  protected final String TEXT_52 = NL + "        lookUpKey_";
  protected final String TEXT_53 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_54 = " = cache_";
  protected final String TEXT_55 = ".get(lookUpKey_";
  protected final String TEXT_56 = ");";
  protected final String TEXT_57 = "    " + NL + "    if(lookUpValue_";
  protected final String TEXT_58 = " == null) {";
  protected final String TEXT_59 = NL + "            lookUpValue_";
  protected final String TEXT_60 = NL + "                lookUpValue_";
  protected final String TEXT_61 = " = 1;";
  protected final String TEXT_62 = NL + "        ";
  protected final String TEXT_63 = NL + "                    ";
  protected final String TEXT_64 = " skRoutine_";
  protected final String TEXT_65 = "                    ";
  protected final String TEXT_66 = NL + "                    nextSurrogateKey_";
  protected final String TEXT_67 = "++;";
  protected final String TEXT_68 = NL + "                ";
  protected final String TEXT_69 = " version_";
  protected final String TEXT_70 = NL + "        nb_line_inserted_";
  protected final String TEXT_71 = " += insertionStatement_";
  protected final String TEXT_72 = ".executeUpdate();";
  protected final String TEXT_73 = NL + "            System.out.println(\"[";
  protected final String TEXT_74 = "] new source id inserted\");";
  protected final String TEXT_75 = NL + "    } else {";
  protected final String TEXT_76 = NL + "            if(";
  protected final String TEXT_77 = ") {";
  protected final String TEXT_78 = NL + "                nb_line_update_";
  protected final String TEXT_79 = " += updateForType1_";
  protected final String TEXT_80 = NL + "                    System.out.println(\"[";
  protected final String TEXT_81 = "] l1 update done\");";
  protected final String TEXT_82 = NL + "            }";
  protected final String TEXT_83 = " += updateForType2_";
  protected final String TEXT_84 = NL + "                            ";
  protected final String TEXT_85 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_86 = NL + "                        ";
  protected final String TEXT_87 = " maxVersion_";
  protected final String TEXT_88 = " = lookUpValue_";
  protected final String TEXT_89 = " + 1;";
  protected final String TEXT_90 = NL + "                            lookUpValue_";
  protected final String TEXT_91 = " + 1;                            ";
  protected final String TEXT_92 = NL + "                nb_line_inserted_";
  protected final String TEXT_93 = "] new history line\");";
  protected final String TEXT_94 = NL + "                    if (";
  protected final String TEXT_95 = NL + "                   \t} else {" + NL + "                   \t";
  protected final String TEXT_96 = NL + "                   \t}" + NL + "                   \t";
  protected final String TEXT_97 = NL + "                   \t";
  protected final String TEXT_98 = " += updateForType3_";
  protected final String TEXT_99 = "] l3 update done\");";
  protected final String TEXT_100 = NL + "    }" + NL + "" + NL + "\t} catch (java.lang.Exception e) {//catch" + NL + "  \t\t";
  protected final String TEXT_101 = NL + "            throw(e);";
  protected final String TEXT_102 = " = new ";
  protected final String TEXT_103 = "Struct();";
  protected final String TEXT_104 = NL + "                nb_line_rejected_";
  protected final String TEXT_105 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_108 = NL + "\t}//end catch" + NL + "\t";
  protected final String TEXT_109 = NL + "        cache_";
  protected final String TEXT_110 = ".put(lookUpKey_";
