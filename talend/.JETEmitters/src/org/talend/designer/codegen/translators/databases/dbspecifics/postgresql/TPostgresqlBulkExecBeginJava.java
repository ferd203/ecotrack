...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_56 = NL + "int deletedCount_";
  protected final String TEXT_57 = "=0;" + NL + "String tableName_";
  protected final String TEXT_58 = " = null;" + NL + "String dbschema_";
  protected final String TEXT_59 = " = null;";
  protected final String TEXT_60 = NL + "\tdbschema_";
  protected final String TEXT_61 = " = (String)globalMap.get(\"schema_\" + \"";
  protected final String TEXT_62 = "\");" + NL + "\t";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";" + NL + "\t";
  protected final String TEXT_65 = NL + "if(dbschema_";
  protected final String TEXT_66 = " == null || dbschema_";
  ...
  protected final String TEXT_72 = NL + "     String tmpTableName_";
  protected final String TEXT_73 = " = \"tmp_";
  protected final String TEXT_74 = "_\" + pid + Thread.currentThread().getId(); //tableName not end. will add pid + Thread.currentThread().getId() when create a temp table for update.";
  protected final String TEXT_75 = NL + "String bulkSQL_";
  protected final String TEXT_76 = " = \"COPY \\\"\" + ";
  protected final String TEXT_77 = "tmpTableName_";
  protected final String TEXT_78 = "tableName_";
  protected final String TEXT_79 = " ";
  protected final String TEXT_80 = NL + "+ \"\\\"";
  protected final String TEXT_81 = "FROM \" + " + NL + "\t\t";
  protected final String TEXT_82 = " \"'\" + ";
  protected final String TEXT_83 = ".replaceAll(\"\\\"\",\"\") +\"'\" ";
  protected final String TEXT_84 = " \"STDIN\" ";
  protected final String TEXT_85 = NL + "\t\t+ \" WITH \";";
  protected final String TEXT_86 = NL + "    bulkSQL_";
  protected final String TEXT_87 = " += \"BINARY ";
  protected final String TEXT_88 = "\";";
  protected final String TEXT_89 = NL + "    Character field_separator_";
  protected final String TEXT_90 = " = (";
  protected final String TEXT_91 = ").charAt(0);" + NL + "    bulkSQL_";
  protected final String TEXT_92 = " += \"";
  protected final String TEXT_93 = " \" + \"DELIMITER AS '\" + field_separator_";
  protected final String TEXT_94 = " + \"' \";" + NL + "\t";
  protected final String TEXT_95 = NL + "\t\tbulkSQL_";
  protected final String TEXT_96 = " += \"NULL AS '\" + ";
  protected final String TEXT_97 = ".replaceAll(\"\\\\\\\\\",\"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t";
  protected final String TEXT_98 = NL + "        Character text_enclosure_";
  protected final String TEXT_99 = ").charAt(0);";
  protected final String TEXT_100 = NL + "            \tbulkSQL_";
  protected final String TEXT_101 = " += \"CSV ";
  protected final String TEXT_102 = " QUOTE AS '\" + ";
  protected final String TEXT_103 = "+ \"' \";" + NL + "\t\t";
  protected final String TEXT_104 = NL + "\t\t        bulkSQL_";
  protected final String TEXT_105 = " QUOTE AS \" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_106 = ".toString())?\"E\":\"\") + \"'\" +(\"'\".equals(text_enclosure_";
  protected final String TEXT_107 = ")?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_108 = " + \"' \";" + NL + "\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\tbulkSQL_";
  protected final String TEXT_110 = " += \"ESCAPE AS '\" + ";
  protected final String TEXT_111 = NL + "\t        \tbulkSQL_";
  protected final String TEXT_112 = " += \"ESCAPE AS \" + (\"'\".equals(";
  protected final String TEXT_113 = ")?\"E\":\"\")  + \"'\" +(\"'\".equals(";
  protected final String TEXT_114 = ")?\"\\\\\":\"\") + ";
  protected final String TEXT_115 = " + \"' \"; ";
  protected final String TEXT_116 = NL + NL + "       \t\t\tbulkSQL_";
  protected final String TEXT_117 = " QUOTE AS '\" +  ";
  protected final String TEXT_118 = ".replace(\"\\\\\", \"\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_119 = " QUOTE AS '\" + (\"'\".equals(text_enclosure_";
  protected final String TEXT_120 = ".toString())?\"\\\\\":\"\") + text_enclosure_";
  protected final String TEXT_121 = ".toString().replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  protected final String TEXT_122 = " += \"ESCAPE AS '\"+ ";
  protected final String TEXT_123 = " += \"ESCAPE AS '\"+ (\"'\".equals(";
  protected final String TEXT_124 = ".replaceAll(\"\\\\\\\\\", \"\\\\\\\\\\\\\\\\\") + \"' \";" + NL + "\t\t";
  ...
  protected final String TEXT_132 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_133 = " = \"com.pivotal.jdbc.GreenplumDriver\";" + NL + "\t\t\t";
  protected final String TEXT_134 = NL + "\t            String url_";
  protected final String TEXT_135 = " = \"jdbc:pivotal:greenplum://\"+";
  protected final String TEXT_136 = "+\":\"+";
  protected final String TEXT_137 = "+\";DatabaseName=\"+";
  protected final String TEXT_138 = ";" + NL + "\t            ";
  protected final String TEXT_139 = " + \"?\" + ";
  protected final String TEXT_140 = NL + "\t\t";
  protected final String TEXT_141 = " = \"org.postgresql.Driver\";" + NL + "\t\t\t";
  protected final String TEXT_142 = " = \"jdbc:postgresql://\" + ";
  protected final String TEXT_143 = " + \":\" + ";
  protected final String TEXT_144 = " + \"/\" + ";
  protected final String TEXT_145 = NL + "\t\t" + NL + "\t\tString dbUser_";
  protected final String TEXT_146 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  protected final String TEXT_147 = ").newInstance();" + NL + "\t\t";
  ...
  protected final String TEXT_169 = " - Drop table ";
  protected final String TEXT_170 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_171 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_172 = " - Creating table ";
  protected final String TEXT_173 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\troutines.system.Dynamic dynamicColumn = (Dynamic)globalMap.get(\"";
  protected final String TEXT_175 = "\" + \"_DYNAMIC\");" + NL + "\t\t\t\tfor (DynamicMetadata column : dynamicColumn.metadatas){" + NL + "\t\t\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\t\tif (column.getType().equals(\"id_Double\")){" + NL + "\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_177 = ");" + NL + "\t\t\t\t\t} else if (column.getType().equals(\"id_String\")){" + NL + "\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_178 = ");" + NL + "\t\t\t\t\t} else if (column.getType().equals(\"id_Boolean\")){" + NL + "\t\t\t\t\t\tcolumn.setType(\"id_String\");" + NL + "\t\t\t\t\t\tcolumn.setLength(5);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tString columnsPart = DynamicUtils.getCreateTableSQL(dynamicColumn, \"";
  protected final String TEXT_179 = "\");" + NL + "\t\t\t\tString queryForExec = \"CREATE TABLE [\" + tableName_";
  protected final String TEXT_180 = " + \"](\" + columnsPart + \")\";" + NL + "\t\t\t\t";
  protected final String TEXT_181 = NL + "\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_182 = " - Creating table with query: \" + queryForExec);" + NL + "\t\t\t\t";
  protected final String TEXT_183 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_184 = ".execute(queryForExec);" + NL + "\t\t\t";
  protected final String TEXT_185 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_186 = " - Create table ";
  ...
  protected final String TEXT_205 = ".getMetaData();" + NL + "\t\t\t\tjava.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_218 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_226 = " = false;" + NL + "\t\t\t\tString defaultSchema_";
  protected final String TEXT_227 = " = \"public\";" + NL + "\t\t\t\tif(dbschema_";
  protected final String TEXT_228 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  protected final String TEXT_229 = ".createStatement();" + NL + "\t\t\t\t\tjava.sql.ResultSet rsSchema_";
  protected final String TEXT_230 = " = stmtSchema_";
  protected final String TEXT_231 = ".executeQuery(\"select current_schema() \");" + NL + "\t\t\t\t\twhile(rsSchema_";
  protected final String TEXT_232 = ".next()){" + NL + "\t\t\t\t\t\tdefaultSchema_";
  protected final String TEXT_233 = " = rsSchema_";
  protected final String TEXT_234 = ".getString(\"current_schema\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\trsSchema_";
  protected final String TEXT_235 = ".close();" + NL + "\t\t\t\t\tstmtSchema_";
  protected final String TEXT_236 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\twhile(rsTable_";
  ...
  protected final String TEXT_242 = " ==null || dbschema_";
  protected final String TEXT_243 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_244 = "(schema_";
  protected final String TEXT_245 = NL + "            \tString tableForSearch_";
  protected final String TEXT_246 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_247 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_248 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_249 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_250 = " =  tableForSearch_";
  protected final String TEXT_251 = ".substring(1,tableForSearch_";
  protected final String TEXT_252 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_253 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_259 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_260 = ".getTables(null, dbschema_";
  ...
  protected final String TEXT_264 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_270 = ", null, null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_276 = NL + "\t\t\t\tif(!whetherExist_";
  protected final String TEXT_277 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_278 = ".createStatement();" + NL + "\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_280 = ".\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\t\t";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\troutines.system.Dynamic dynamicColumn = (Dynamic)globalMap.get(\"";
  protected final String TEXT_283 = "\" + \"_DYNAMIC\");" + NL + "\t\t\t\t\t\tfor (DynamicMetadata column : dynamicColumn.metadatas){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_284 = NL + "\t\t\t\t\t\t\tif (column.getType().equals(\"id_Double\")){" + NL + "\t\t\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_285 = ");" + NL + "\t\t\t\t\t\t\t} else if (column.getType().equals(\"id_String\")){" + NL + "\t\t\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_286 = ");" + NL + "\t\t\t\t\t\t\t} else if (column.getType().equals(\"id_Boolean\")){" + NL + "\t\t\t\t\t\t\t\tcolumn.setType(\"id_String\");" + NL + "\t\t\t\t\t\t\t\tcolumn.setLength(5);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tString columnsPart = DynamicUtils.getCreateTableSQL(dynamicColumn, \"";
  protected final String TEXT_287 = "\");" + NL + "\t\t\t\t\t\tString queryForExec = \"CREATE TABLE [\" + tableName_";
  protected final String TEXT_288 = " + \"](\" + columnsPart + \")\";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_289 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_290 = " - Creating table with query: \" + queryForExec);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_291 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_292 = ".execute(queryForExec);" + NL + "\t\t\t\t\t";
  protected final String TEXT_293 = ")\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_294 = " has succeeded.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_295 = NL + "\t\t\t\t\tstmtCreate_";
  protected final String TEXT_296 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_297 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_298 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  protected final String TEXT_299 = NL + "\t\t\t\t\tstmtDrop_";
  protected final String TEXT_300 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_301 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_302 = ".createStatement();" + NL + "\t\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\tlog.info(\"";
  protected final String TEXT_304 = ".\" );" + NL + "\t\t\t\t";
  protected final String TEXT_305 = NL + "\t\t\t\t\troutines.system.Dynamic dynamicColumn = (Dynamic)globalMap.get(\"";
  protected final String TEXT_306 = "\" + \"_DYNAMIC\");" + NL + "\t\t\t\t\tfor (DynamicMetadata column : dynamicColumn.metadatas){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_307 = NL + "\t\t\t\t\t\tif (column.getType().equals(\"id_Double\")){" + NL + "\t\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_308 = ");" + NL + "\t\t\t\t\t\t} else if (column.getType().equals(\"id_String\")){" + NL + "\t\t\t\t\t\t\tcolumn.setLength(";
  protected final String TEXT_309 = ");" + NL + "\t\t\t\t\t\t} else if (column.getType().equals(\"id_Boolean\")){" + NL + "\t\t\t\t\t\t\tcolumn.setType(\"id_String\");" + NL + "\t\t\t\t\t\t\tcolumn.setLength(5);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tString columnsPart = DynamicUtils.getCreateTableSQL(dynamicColumn, \"";
  protected final String TEXT_310 = "\");" + NL + "\t\t\t\t\tString queryForExec = \"CREATE TABLE [\" + tableName_";
  protected final String TEXT_311 = " + \"](\" + columnsPart + \")\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_312 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_313 = " - Creating table with query: \" + queryForExec);" + NL + "\t\t\t\t\t";
  protected final String TEXT_314 = ".execute(queryForExec);" + NL + "\t\t\t\t";
  protected final String TEXT_315 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_316 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_318 = " - Clearing table ";
  protected final String TEXT_319 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_320 = ".executeUpdate(\"";
  protected final String TEXT_321 = "- Clear table ";
  protected final String TEXT_322 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_327 = " - Trancating table ";
  protected final String TEXT_328 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_329 = "\");" + NL + "   \t    \t";
  protected final String TEXT_330 = " - Truncate table ";
  ...
  protected final String TEXT_337 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_338 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_339 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_340 = NL + "        int keyCount_";
  protected final String TEXT_341 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_342 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        tmpTableName_";
  protected final String TEXT_343 = " = tableName_";
  protected final String TEXT_344 = ";" + NL + "        tableName_";
  protected final String TEXT_345 = "\" + \"_\" + pid + Thread.currentThread().getId();        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_346 = ".createStatement();" + NL + "\t\t";
  protected final String TEXT_347 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_348 = " - Creating temp table ";
  protected final String TEXT_349 = ".\" );" + NL + "\t\t";
  protected final String TEXT_350 = NL + NL + "        stmtCreateTmp_";
  protected final String TEXT_351 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_352 = " - Create temp table ";
  protected final String TEXT_353 = " has succeeded.\");" + NL + "\t\t";
  protected final String TEXT_354 = NL + "        ";
  protected final String TEXT_355 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_356 = " =conn_";
  protected final String TEXT_357 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_358 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_359 = ".close();" + NL + "   \t\t";
  protected final String TEXT_360 = "        " + NL + "        " + NL + "\t\t";
  protected final String TEXT_361 = NL + "\t\t\tjava.sql.Statement stmtBulk_";
  protected final String TEXT_362 = ".createStatement();" + NL + "\t\t\t//stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t\t\tstmtBulk_";
  protected final String TEXT_363 = ".execute(bulkSQL_";
  protected final String TEXT_364 = ");" + NL + "\t\t\tstmtBulk_";
  protected final String TEXT_365 = ".close(); " + NL + "\t\t";
  protected final String TEXT_366 = NL + "\t\t\ttry (java.io.FileReader fileReader = new java.io.FileReader(";
  protected final String TEXT_367 = ")){" + NL + "\t\t\t\torg.postgresql.copy.CopyManager copyManager = new org.postgresql.copy.CopyManager((org.postgresql.core.BaseConnection) conn_";
  protected final String TEXT_368 = ");" + NL + "\t\t\t\tcopyManager.copyIn(bulkSQL_";
  protected final String TEXT_369 = ", fileReader );" + NL + "\t\t\t} \t\t\t" + NL + "\t\t";
  protected final String TEXT_370 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_371 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_372 = "+\".\");" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_373 = " - Bulk inserting data into ";
  protected final String TEXT_374 = " - Bulk insert data into ";
  protected final String TEXT_375 = " has finished.\");" + NL + "\t\t";
  protected final String TEXT_376 = NL + "        tableName_";
  protected final String TEXT_377 = " = tmpTableName_";
  protected final String TEXT_378 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_379 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_380 = " - Updating ";
  protected final String TEXT_381 = " from ";
  protected final String TEXT_382 = "\"+tmpTableName_";
  protected final String TEXT_383 = "+\"";
  protected final String TEXT_384 = ".\");" + NL + "\t\t";
  protected final String TEXT_385 = NL + "        stmtUpdateBulk_";
  protected final String TEXT_386 = "\");" + NL + "\t\t";
  protected final String TEXT_387 = ".close();" + NL + "        tableName_";
  protected final String TEXT_388 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_389 = " - Droping temp table ";
  protected final String TEXT_390 = NL + "        stmtTmpDrop_";
  protected final String TEXT_391 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_392 = " - Drop temp table ";
  protected final String TEXT_393 = "+ \"";
  protected final String TEXT_394 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_395 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_396 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_397 = NL + "    " + NL + "\t";
  protected final String TEXT_398 = NL + "\t\tjava.sql.Statement stmtBulk_";
  protected final String TEXT_399 = ".createStatement();" + NL + "\t\t//stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "\t\tstmtBulk_";
  protected final String TEXT_400 = ");" + NL + "\t\tstmtBulk_";
  protected final String TEXT_401 = ".close(); " + NL + "\t";
  protected final String TEXT_402 = NL + "\t\ttry (java.io.FileReader fileReader = new java.io.FileReader(";
  protected final String TEXT_403 = ")){" + NL + "\t\t\torg.postgresql.copy.CopyManager copyManager = new org.postgresql.copy.CopyManager((org.postgresql.core.BaseConnection) conn_";
  protected final String TEXT_404 = ");" + NL + "\t\t\tcopyManager.copyIn(bulkSQL_";
  protected final String TEXT_405 = ", fileReader );" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_406 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_407 = "+\".\");" + NL + "\t\tlog.info(\"";
  protected final String TEXT_408 = " - Inserting records in table ";
  protected final String TEXT_409 = ".\");" + NL + "\t";
  protected final String TEXT_410 = NL + "\t" + NL + "\t";
  protected final String TEXT_411 = NL + "\t\tlog.info(\"";
  protected final String TEXT_412 = " - Insert records in table ";
  protected final String TEXT_413 = " has finished.\");" + NL + "\t";
