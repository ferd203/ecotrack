...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_166 = ".getTables(";
  protected final String TEXT_167 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_172 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_173 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_174 = NL + "                                if(!whetherExist_";
  protected final String TEXT_175 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_176 = NL + "                                                      stmtCreate_";
  protected final String TEXT_177 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_178 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_179 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_180 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_181 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_190 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_191 = NL + "                                                  stmtCreate_";
  protected final String TEXT_192 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_193 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_194 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_195 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_196 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_201 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_202 = NL + "                              stmtClear_";
  protected final String TEXT_203 = NL + "                stmtClear_";
  protected final String TEXT_204 = ".executeUpdate(\"";
  protected final String TEXT_205 = "\");";
  protected final String TEXT_206 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_207 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_208 = NL + "                              stmtTruncCount_";
  protected final String TEXT_209 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_210 = " = stmtTruncCount_";
  protected final String TEXT_211 = ".executeQuery(\"";
  protected final String TEXT_212 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_213 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_214 = " = rsTruncCount_";
  protected final String TEXT_215 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_216 = NL + "                              stmtTrunc_";
  protected final String TEXT_217 = NL + "                conn_";
  protected final String TEXT_218 = NL + "                stmtTrunc_";
  protected final String TEXT_219 = NL + "                    if(!conn_";
  protected final String TEXT_220 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_221 = ".commit();" + NL + "                    }";
  protected final String TEXT_222 = NL + "                deletedCount_";
  protected final String TEXT_223 = " += rsTruncCountNumber_";
  protected final String TEXT_224 = ";" + NL + "            }";
  protected final String TEXT_225 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_226 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_227 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_228 = NL + "                while(rsTruncCount_";
  protected final String TEXT_229 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_230 = " += rsTruncCount_";
  protected final String TEXT_231 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_232 = NL + "\t\t\troutines.system.Dynamic dynamic_";
  protected final String TEXT_233 = ";" + NL + "            if (";
  protected final String TEXT_234 = ") {" + NL + "                for (int i = 0; i < dynamic_";
  protected final String TEXT_235 = ".getColumnCount(); i++) {" + NL + "                \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_236 = ".getColumnMetadata(i);" + NL + "                \tcolumn.setName(column.getName().toLowerCase());" + NL + "                }" + NL + "            }";
  protected final String TEXT_237 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_238 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_239 = " + \"\\\" (";
  protected final String TEXT_240 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(dynamic_";
  protected final String TEXT_241 = "\")+\") VALUES (";
  protected final String TEXT_242 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(dynamic_";
  protected final String TEXT_243 = ")+\")\";";
  protected final String TEXT_244 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(dynamic_";
  protected final String TEXT_245 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(dynamic_";
  protected final String TEXT_246 = NL + "    pstmt_";
  protected final String TEXT_247 = ".prepareStatement(insert_";
  protected final String TEXT_248 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_249 = "\", pstmt_";
  protected final String TEXT_250 = " = null;" + NL + "    String keyPsmt_";
  protected final String TEXT_251 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_252 = " + \"]\";" + NL + "    if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_253 = ")== null){" + NL + "        pstmt_";
  protected final String TEXT_254 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_255 = ");" + NL + "        GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_256 = ", pstmt_";
  protected final String TEXT_257 = ");" + NL + "    }else{" + NL + "        pstmt_";
  protected final String TEXT_258 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_263 = ", \"+DynamicUtils.getUpdateSet(dynamic_";
  protected final String TEXT_264 = "\")+\" WHERE ";
  protected final String TEXT_265 = "\";";
  protected final String TEXT_266 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(dynamic_";
  ...
  protected final String TEXT_271 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_272 = " + \"\\\" WHERE ";
  protected final String TEXT_273 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_274 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_275 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_276 = "\", pstmtInsert_";
  protected final String TEXT_277 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_278 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_279 = "\", pstmtUpdate_";
  protected final String TEXT_280 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_281 = NL + "\t    String delete_";
  protected final String TEXT_282 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_283 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_284 = ".prepareStatement(delete_";
  protected final String TEXT_285 = NL + "       \t";
  protected final String TEXT_286 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_287 = " = insert_";
  protected final String TEXT_288 = ".split(\"\\\\?\");";
  protected final String TEXT_289 = NL + "\t\t\tupdate_";
  protected final String TEXT_290 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_291 = " = update_";
  protected final String TEXT_292 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_293 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_294 = NL + "\t\t\tdelete_";
  protected final String TEXT_295 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_296 = " = delete_";
  protected final String TEXT_297 = NL + "\t\t\treplace_";
  protected final String TEXT_298 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_299 = " = replace_";
  protected final String TEXT_300 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_301 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_302 = " = insertIgnore_";
  protected final String TEXT_303 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_304 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_305 = " = buffersSize_";
  protected final String TEXT_306 = ";";
  protected final String TEXT_307 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_308 = NL + "        whetherReject_";
  protected final String TEXT_309 = " = false;";
  protected final String TEXT_310 = NL + "                        query_";
  protected final String TEXT_311 = NL + "                            geometryColumnName_";
  protected final String TEXT_312 = " = \"";
  protected final String TEXT_313 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_314 = ") {" + NL + "                                dimension_";
  protected final String TEXT_315 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_316 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_317 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_318 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_319 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_320 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_321 = " = refSys_";
  protected final String TEXT_322 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_323 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_324 = " == null || ident_";
  protected final String TEXT_325 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_326 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_327 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_328 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_329 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_330 = " = Integer.parseInt(code_";
  protected final String TEXT_331 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_332 = " = \"SRID_";
  protected final String TEXT_333 = " could not be determined\";";
  protected final String TEXT_334 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_335 = ");" + NL + "                                            SRID_";
  protected final String TEXT_336 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_337 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_338 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_339 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_340 = ",";
  protected final String TEXT_341 = ", ";
  protected final String TEXT_342 = ",insertSQLSplits_";
  protected final String TEXT_343 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_344 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_351 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_352 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_353 = NL + "    \t\t  ";
  protected final String TEXT_354 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_355 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_356 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_357 = NL + "                \tsp_";
  protected final String TEXT_358 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_359 = NL + "                insertedCount_";
  protected final String TEXT_360 = " = insertedCount_";
  ...
  protected final String TEXT_365 = ".releaseSavepoint(sp_";
  protected final String TEXT_366 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_367 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_368 = ".rollback(sp_";
  protected final String TEXT_369 = ");" + NL + "\t            ";
  protected final String TEXT_370 = NL + "                whetherReject_";
  protected final String TEXT_371 = " = true;";
  protected final String TEXT_372 = NL + "                    throw(e);";
  protected final String TEXT_373 = " = new ";
  protected final String TEXT_374 = "Struct();";
  protected final String TEXT_375 = NL + "                        rejectedCount_";
  protected final String TEXT_376 = " = rejectedCount_";
  protected final String TEXT_377 = " + 1;";
  protected final String TEXT_378 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_379 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_380 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_381 = NL + "            }";
  protected final String TEXT_382 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_383 = ",updateSQLSplits_";
  protected final String TEXT_384 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_385 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_386 = NL + "\t\t\t\t\t   ";
  protected final String TEXT_387 = NL + "\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t\t\tquery_";
  protected final String TEXT_389 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\t\t   query_";
  protected final String TEXT_391 = ";" + NL + "\t\t\t    ";
  protected final String TEXT_392 = NL + "\t                sp_";
  protected final String TEXT_393 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_394 = NL + "                updatedCount_";
  protected final String TEXT_395 = " = updatedCount_";
  protected final String TEXT_396 = NL + "                \tconn_";
  protected final String TEXT_397 = NL + "                    \t";
  protected final String TEXT_398 = NL + "            int checkCount_";
  protected final String TEXT_399 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_400 = " = pstmt_";
  protected final String TEXT_401 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_402 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_403 = " = rs_";
  protected final String TEXT_404 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_405 = " > 0) {";
  protected final String TEXT_406 = NL + "                            query_";
  protected final String TEXT_407 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_408 = ", pstmtUpdate_";
  protected final String TEXT_409 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_410 = NL + "\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_411 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_412 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_413 = NL + "                    globalMap.put(\"";
  protected final String TEXT_414 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_415 = NL + "\t                    sp_";
  protected final String TEXT_416 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_417 = NL + "                    updatedCount_";
  protected final String TEXT_418 = " + pstmtUpdate_";
  protected final String TEXT_419 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_420 = "++;";
  protected final String TEXT_421 = NL + "    \t                conn_";
  protected final String TEXT_422 = ");" + NL + "    \t            ";
  protected final String TEXT_423 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_424 = NL + "                    whetherReject_";
  protected final String TEXT_425 = NL + "                        throw(e);";
  protected final String TEXT_426 = NL + "                        nb_line_";
  protected final String TEXT_427 = NL + "                                ";
  protected final String TEXT_428 = NL + "                            rejectedCount_";
  protected final String TEXT_429 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_430 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_432 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_434 = ", pstmtInsert_";
  protected final String TEXT_435 = NL + "                    insertedCount_";
  protected final String TEXT_436 = " + pstmtInsert_";
  protected final String TEXT_437 = NL + "                }" + NL + "            }";
  protected final String TEXT_438 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_444 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_445 = NL + "                updateFlag_";
  protected final String TEXT_446 = "=pstmtUpdate_";
  protected final String TEXT_447 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_448 = "+updateFlag_";
  protected final String TEXT_449 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_450 = NL + "            if(updateFlag_";
  protected final String TEXT_451 = " == 0) {" + NL + "            \t";
  protected final String TEXT_452 = NL + "\t\t\t\tquery_";
  protected final String TEXT_453 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_454 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_455 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_456 = "++;" + NL + "    \t\t\t\t\t";
  protected final String TEXT_457 = NL + "     \t\t\t\t\t";
  protected final String TEXT_458 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_465 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_466 = NL + "                deletedCount_";
  protected final String TEXT_467 = " = deletedCount_";
  protected final String TEXT_468 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_469 = NL + "                    nb_line_";
  protected final String TEXT_470 = NL + "            if(!whetherReject_";
  protected final String TEXT_471 = ") {";
  protected final String TEXT_472 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_473 = " > 0) && (batchSize_";
  protected final String TEXT_474 = " <= batchSizeCounter_";
  protected final String TEXT_475 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_476 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_477 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_478 = ": pstmt_";
  protected final String TEXT_479 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_480 = " += (countEach_";
  protected final String TEXT_481 = " < 0 ? 0 : countEach_";
  protected final String TEXT_482 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_483 = NL + "\t\t\t\t    \t";
  protected final String TEXT_484 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_485 = " += countSum_";
  protected final String TEXT_486 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_487 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_488 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_489 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_490 = "){" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_491 = " = e_";
  protected final String TEXT_492 = ".getNextException(),sqle_";
  ...
  protected final String TEXT_496 = " = new java.sql.SQLException(e_";
  protected final String TEXT_497 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_498 = ".getMessage(), ne_";
  protected final String TEXT_499 = ".getSQLState(), ne_";
  protected final String TEXT_500 = ".getErrorCode(), ne_";
  protected final String TEXT_501 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_502 = " = sqle_";
  protected final String TEXT_503 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_504 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_505 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_506 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_507 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_508 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_509 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_510 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_511 = ": e_";
  protected final String TEXT_512 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_513 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_514 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_515 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_516 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_517 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_518 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_519 = " <= commitCounter_";
  protected final String TEXT_520 = NL + "                if ((batchSize_";
  protected final String TEXT_521 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_522 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_523 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_524 = NL + "            \t    \t";
  protected final String TEXT_525 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_526 = ";" + NL + "            \t    \t";
  protected final String TEXT_527 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_528 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_529 = NL + "                batchSizeCounter_";
  protected final String TEXT_530 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_531 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_532 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_533 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_534 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_535 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_536 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_537 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_538 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_539 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_540 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_541 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t    \t";
  protected final String TEXT_542 = NL + "\t\t\t    \tint countSum_";
  protected final String TEXT_543 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_544 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_545 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_546 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_547 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_548 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_549 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_550 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_551 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_552 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_553 = ".commit();" + NL + "                \t";
  protected final String TEXT_554 = NL + "                \tcommitCounter_";
  protected final String TEXT_555 = "=0;" + NL + "                }";
