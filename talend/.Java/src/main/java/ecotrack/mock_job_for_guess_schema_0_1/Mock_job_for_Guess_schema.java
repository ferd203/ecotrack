...
package ecotrack.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String additionalParams = "neondb?sslmode=require&channel_binding=require";
				...
				String password = "npg_7nhkWXqJU1tA";
				...
				String url = "jdbc:postgresql://ep-weathered-cherry-aies0456-pooler.c-4.us-east-1.aws.neon.tech:5432/neondb?neondb?sslmode=require&channel_binding=require";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("SELECT    \"" + context.ecotrack_dw1_Database + "\".\""
						+ context.ecotrack_dw1_Schema + "\".\"dim_route\".\"route_sk\",    \""
						+ context.ecotrack_dw1_Database + "\".\"" + context.ecotrack_dw1_Schema
						+ "\".\"dim_route\".\"route_bk\",    \"" + context.ecotrack_dw1_Database + "\".\""
						+ context.ecotrack_dw1_Schema + "\".\"dim_route\".\"route_date\",    \""
						+ context.ecotrack_dw1_Database + "\".\"" + context.ecotrack_dw1_Schema
						+ "\".\"dim_route\".\"planned_distance_m\",    \"" + context.ecotrack_dw1_Database + "\".\""
						+ context.ecotrack_dw1_Schema + "\".\"dim_route\".\"planned_duration_min\",    \""
						+ context.ecotrack_dw1_Database + "\".\"" + context.ecotrack_dw1_Schema
						+ "\".\"dim_route\".\"path\" FROM \"" + context.ecotrack_dw1_Database + "\".\""
						+ context.ecotrack_dw1_Schema + "\".\"dim_route\"");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"D:/LOGICIELS/Logiciels/TOS_DI-20200219_1130-V7.3.1/TOS_DI-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"ecotrack/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 44189 characters generated by Talend Open Studio for Data Integration on the
 * 4 mars 2026 00:24:53 CET
 ************************************************************************************************/