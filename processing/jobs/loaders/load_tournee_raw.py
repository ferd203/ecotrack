...
def main() -> None:
    ...
    if key is None or file_bytes is None:
        print("Aucun fichier tournee_raw transformé trouvé.")
        return
    ...
    print(f"Chargement de {file_name} vers raw.tournee_raw")
    ...
    print(f"Chargement terminé : raw.tournee_raw ({len(df)} lignes)")
